...
function Dashboard() {
    ...
    const toggleAgent = async (id) => {
        if (openAgents.includes(id)) {
            ...
            if (!agentLists[id]) {
                try {
                    const res = await axios.get(`https://agently-nfl2.onrender.com/distributed-list/${id}`, { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }});
    ...
    const fetchAgents = async () => {
        try {
            const res = await axios.get("https://agently-nfl2.onrender.com/allagents", { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }});
            setAgents(res.data);
        } catch (e) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                await axios.put(`https://agently-nfl2.onrender.com/agent/${editingId}`, updateData, { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` } });
                ...
                await axios.post("https://agently-nfl2.onrender.com/createagent", form, { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }});
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://agently-nfl2.onrender.com/agent/${id}`, { headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }, });
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post("https://agently-nfl2.onrender.com/upload",
                formData,
            ...
            openAgents.forEach((id) => {
                axios.get(`https://agently-nfl2.onrender.com/distributed-list/${id}`, {headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }})
